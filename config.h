...
#elif APP_LESSON73_A == 1
#define BOARD_LESSON73_A      1
#include "src/lessons/unit7-lesson73a/app_config.h"
#include "src/lessons/unit7-lesson73a/board_config.h"

#elif APP_LESSON73_B == 1
#define BOARD_LESSON73_B      1
#include "src/lessons/unit7-lesson73b/app_config.h"
#include "src/lessons/unit7-lesson73b/board_config.h"

#elif APP_LESSON81 == 1
#define BOARD_LESSON81      1
#include "src/lessons/unit8-lesson81/app_config.h"
#include "src/lessons/unit8-lesson81/board_config.h"

#elif APP_LESSON82 == 1
#define BOARD_LESSON82      1
#include "src/lessons/unit8-lesson82/app_config.h"
#include "src/lessons/unit8-lesson82/board_config.h"

#elif APP_LESSON83 == 1
#define BOARD_LESSON83      1
#include "src/lessons/unit8-lesson83/app_config.h"
#include "src/lessons/unit8-lesson83/board_config.h"

#elif APP_LESSON91_A == 1
#define BOARD_LESSON91_A      1
#include "src/lessons/unit9-lesson91a/app_config.h"
#include "src/lessons/unit9-lesson91a/board_config.h"

#elif APP_LESSON91_B == 1
#define BOARD_LESSON91_B      1
#include "src/lessons/unit9-lesson91b/app_config.h"
#include "src/lessons/unit9-lesson91b/board_config.h"

#elif APP_LESSON92 == 1
#define BOARD_LESSON92      1
#include "src/lessons/unit9-lesson92/app_config.h"
#include "src/lessons/unit9-lesson92/board_config.h"

#elif APP_LESSON101_A == 1
#define BOARD_LESSON101_A      1
#include "src/lessons/unit10-lesson101a/app_config.h"
#include "src/lessons/unit10-lesson101a/board_config.h"

#elif APP_LESSON101_B == 1
#define BOARD_LESSON101_B      1
#include "src/lessons/unit10-lesson101b/app_config.h"
#include "src/lessons/unit10-lesson101b/board_config.h"

#elif APP_LESSON102_A == 1
#define BOARD_LESSON102_A      1
#include "src/lessons/unit10-lesson102a/app_config.h"
#include "src/lessons/unit10-lesson102a/board_config.h"
