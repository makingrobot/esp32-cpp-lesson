...
#elif APP_LESSON82_A == 1
#define BOARD_LESSON82_A      1
#include "src/lessons/unit8-lesson82a/app_config.h"

#elif APP_LESSON82_B == 1
#define BOARD_LESSON82_B      1
#include "src/lessons/unit8-lesson82b/app_config.h"
