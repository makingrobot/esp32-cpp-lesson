...
static const esp_codec_dev_vol_range_t cjc8910_vol_range = {
    .min_vol = {
        .vol      = 0x01,
        .db_value = -97,
    },
...
static int cjc8910_set_vol(const audio_codec_if_t *h, float db_value)
{
    ...
    uint8_t volume_reg_value = esp_codec_dev_vol_calc_reg(&cjc8910_vol_range, db_value);
...
static int cjc8910_set_mic_gain(const audio_codec_if_t *h, float db)
{
    ...
    int ret = 0;
    uint8_t volume_reg_value = esp_codec_dev_vol_calc_reg(&cjc8910_vol_range, db);
