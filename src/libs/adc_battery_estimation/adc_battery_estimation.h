...
#include "adc_battery_estimation_config.h"
 ...
 */
esp_err_t adc_battery_estimation_get_capacity(adc_battery_estimation_handle_t handle, int *adc_value, float *capacity);
