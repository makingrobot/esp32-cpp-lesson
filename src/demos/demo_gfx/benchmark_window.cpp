...
void benchmark(void* pvParam) {
    gfx = (Arduino_GFX*)pvParam;
...
void BenchmarkWindow::Start() {
    driver_->fillScreen(WHITE);
    //driver_->flush();
    xTaskCreate(benchmark, "Benchmark_Task", 4096, driver_, tskIDLE_PRIORITY, NULL);
}
