...
#include "src/libs/esp_lcd_ili9341/esp_lcd_ili9341.h"

#define TAG "ILI9341Driver"

void ILI9341Driver::InitSpi(spi_host_device_t spi_host, int spi_mode, gpio_num_t cs_num, gpio_num_t dc_num, gpio_num_t rst_num, 
        gpio_num_t mosi_num, gpio_num_t miso_num, gpio_num_t clk_num, lcd_rgb_element_order_t rgb_color_order, bool invert_color ) {

    Log::Debug(TAG, "Install ILI9341 driver");
