...
public:
    ...
    // source: 0x00, 0x4C, 0x00, 0x69, 0x00, 0x74, 0x00, 0x74, 0x00, 0x6C, 0x00, 0x65, 0x00, 0x20, 0x00, 0x4C, 
    //         0x00, 0x6F, 0x00, 0x6E, 0x00, 0x64, 0x00, 0x6F, 0x00, 0x6E, 0x00, 0x20, 0x00, 0x47, 0x00,
    ...
    // —————————————————————————————————————————————————————————————————————————————————
    // 📌📌📌  T O _ U I N T 6 4  📌📌📌
    // Retrieves the numeric value (uint64_t) from the stored string, 
    // parsing it as a number in the specified base (default: 16 for hexadecimal).
    ...
    // —————————————————————————————————————————————————————————————————————————————————————————————————————
    // 📌📌📌  T O _ U I N T 3 2  📌📌📌
    // Retrieves the numeric value (uint32_t) from the stored string, parsing it as a number in the specified 
    // base (default: 10 for decimal).
    ...
    // ———————————————————————————————————————————————————————————————————————————————————————————————————
    // 📌📌📌  B I G _ E N D I A N  📌📌📌
    // Reads up to 8 bytes from a uint8_t array in big-endian order and stores the value as a hexadecimal 
    // string (e.g., "0x12345678").
    ...
    // Reads up to 8 bytes from a uint8_t array in little-endian order and stores the value as a hexadecimal 
    // string (e.g., "0x12345678").
